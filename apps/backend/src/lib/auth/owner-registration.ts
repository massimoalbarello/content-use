export const OWNER_USER_ID = 'content-use-owner';
export const OWNER_SYNTHETIC_EMAIL = 'content-use-owner@content-use.invalid';
export const OWNER_DISPLAY_NAME = 'Content Use Owner';
...
const ERROR_MESSAGES: Record<OwnerRegistrationErrorCode, string> = {
  owner_already_registered: 'This Content Use instance already has an owner.',
